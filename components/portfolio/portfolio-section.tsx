...
const projects = [
  {
    ...
    tags: ["Commerce", "Promotion", "Maintenance"],
  },
  {
    id: 2,
    title: "넷마블스토어",
    ...
    tags: ["Global Commerce", "Cross Browsing", "Maintenance"],
  },
  {
    id: 3,
    title: "코웨이 마이크로사이트",
    description: "코웨이 브랜드 및 매트리스 마이크로 사이트 신규 구축. 프리미엄 시각 경험 제공.",
    image: "/projects/portfolio1.jpg",
    url: "https://www.dtribe.co.kr/portfolio.php?no=127",
    tags: ["Brand Site", "New Build", "Premium UI"],
  },
  {
    id: 4,
    title: "쌍용자동차 렉스턴",
    ...
    tags: ["Micro Site", "New Build", "Automotive"],
  },
  {
    id: 5,
    title: "롯데칠성 제로",
    ...
    url: "https://www.dtribe.co.kr/portfolio.php?no=125&more=0",
    tags: ["Brand Site", "Campaign", "Food & Bev"],
  },
  {
    id: 6,
    title: "하나금융파트너",
    ...
    url: "https://www.dtribe.co.kr/portfolio.php?no=125&more=0",
    tags: ["Finance", "Web Standard", "Cross Browsing"],
  },
  {
    id: 7,
    title: "OK저축은행",
  ...
  },
  {
    ...
    tags: ["Corporate", "Publishing"],
  },
  {
    id: 10,
    title: "스와니코코",
    description: "스와니코코 쇼핑몰 유지보수.",
    image: "/placeholder.svg",
    url: "http://www.swanicoco.co.kr",
    tags: ["Commerce", "Beauty", "Maintenance"],
  },
  {
    id: 11,
    title: "한국제지",
    ...
    tags: ["Corporate", "Manufacturing", "Publishing"],
  },
]
